...
function checkDangNhap(){
    ...
    if(userArr.username != null && userArr.username != []){
        ...
        document.getElementById('accountUser').innerHTML='<div style="padding:10px;color:red">'+userArr.name+'</div><div><a href="../html/lichsumuahang.html">Lịch sử</a></div><div id="logout" onclick="logout()"><a href="/html/index.html">Logout</a></div>'
    }
...
var data = [
    ...
    {id:004,chatlieu:'nhựa',img: '../img/4.jpg', name : 'SỨ SỞ THẦN TIÊN', gia:325000},
    {id:005,chatlieu:'nhựa',img: '../img/5.jpg', name : 'FERARI VÀNG', gia:25000},
    {id:006,chatlieu:'nhựa',img: '../img/6.jpg', name : 'ĐỒ CHƠI CÔNG TRƯỜNG', gia:625000},
    {id:007,chatlieu:'nhựa',img: '../img/7.jpg', name : 'Mclaren 765lt', gia:125000},
    {id:010,chatlieu:'nhựa',img: '../img/8.jpg', name : 'XE CỨU HỎA', gia:125000},
    {id:011,chatlieu:'nhựa',img: '../img/9.jpg', name : 'BỘ XẾP MAGNETIC', gia:725000},
    {id:012,chatlieu:'Cao su',img: '../img/10.jpg', name : 'BÚP BÊ VÀNG', gia:55000},
    {id:013,chatlieu:'Cao su',img: '../img/11.jpg', name : 'BÚP BÊ ELSA', gia:75000},
    {id:014,chatlieu:'Cao su',img: '../img/12.jpg', name : 'NHÀ VÀ BÚP BÊ', gia:65000},
    {id:015,chatlieu:'Cao su',img: '../img/13.jpg', name : 'BÚP BÊ BIẾT NÓI', gia:55000},
    {id:016,chatlieu:'Cao su',img: '../img/14.jpg', name : 'BỘ TÔ MÀU', gia:50000},
    {id:017,chatlieu:'Cao su',img: '../img/15.jpg', name : 'TẠO HÌNH NGHỆ THUẬT', gia:90000},
